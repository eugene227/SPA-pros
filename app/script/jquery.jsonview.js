...
(function(jQuery) {
  ...
  Collapser = (function() {
    ...
    Collapser.bindEvent = function(item, options) {
      ...
      collapser.innerHTML = options.collapsed ? StateC : StateU;
    ...
    Collapser.expand = function(collapser) {
      ...
      return collapser.innerHTML = StateU;
    };
    ...
    Collapser.collapse = function(collapser) {
      ...
      return collapser.innerHTML = StateC;
    };
  ...
  JSONView = {
    collapse: function(el) {
      if (el.innerHTML === StateU) {
        return Collapser.collapse(el);
      }
    },
    expand: function(el) {
      if (el.innerHTML === StateC) {
